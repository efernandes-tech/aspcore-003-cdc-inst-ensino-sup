...
using Cap08.Data.DAL.Cadastros;
using Microsoft.AspNetCore.Authorization;

namespace Cap08.Areas.Cadastros.Controllers
{
    [Area("Cadastros")]
    public class DepartamentoController : Controller
    {
        ...
        {
            var instituicoes = instituicaoDAL.ObterInstituicaoClassificadasPorNome().ToList();
        ...
        public async Task<IActionResult> Edit(long? id)
        {
            ...
            ViewBag.Instituicoes = new SelectList(instituicaoDAL.ObterInstituicaoClassificadasPorNome(), "InstituicaoID", "Nome", departamento.InstituicaoID);
